...
#model.load_weights(model_path + 'unet_gray_image_01_90_and_181_200.h5')
model.load_weights(model_path + 'unet_gray_image_81_150_thick_suture.h5')
# model.load_weights(model_path + 'unet_gray_image_131_150_thick_suture.h5') # quite good for porcine tissue based manipulation in T-ASE data set
...
###########################################################
###########################################################
path = 'C:/Users/User/OneDrive - The Hong Kong Polytechnic University/PhD Studies/Semester 7/Self-intersection suture thread/Experiment/camera_1/'
#path = 'C:/Users/User/OneDrive - The Hong Kong Polytechnic University/PhD Studies/Semester 8/Revision_TASE/Revised_version/Revised_experiment/experimental_data/porcine/porcine_data/'
#image_name = '2.png'
...
while(num < 9):
    ...
    frame_1 = cv2.imread((path + str(num) + image_type))
    num = num + 1
    ...
    if ((ret_1==True)):# & (ret_2==True)):
        ...
        cv2.imshow('Image - Suture Segmentation', s1)
        #cv2.waitKey(0)
